...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <form action="gallery.php" method = "GET" class="d-flex"> 
                <input list="gameSuggestions" class="form-control me-2" placeholder="Search games..." aria-label="Search" id="Search" name="user-search" type="text">
    ...
    <!-- Hero Carousel -->
    <?php 
        if(empty(isset($_GET['user-search']))) // don't show carousel when showing search
